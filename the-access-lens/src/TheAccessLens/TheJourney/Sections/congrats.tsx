        ...
        <>
            ...
            <div className='congrats' style={{padding: `${padding}px 0px`, marginBottom:'20px'}}>
                ...
                <div className="layout-preview" style={{
                    ...
                    Regardless of whether you love the final product or not, completing this journey shows your commitment to web design and making it more accessible for everyone. While this page primarily focused on color blindness and some aspects of dyslexia, accessibility extends far beyond that. If you want to learn more about designing for people with dyslexia, ADHD, or other disabilities, visit the Understanding Accessibility pages to explore real accounts from individuals sharing what helps and what hinders accessibility. This site is not an exhaustive resource, but aims to amplify real experiences to help you design with inclusivity in mind.<br/><br/>
                    If you’d like to go through the journey again and experiment with different choices, just click the reset journey button at the bottom of the page to restart! 
                    </p>
